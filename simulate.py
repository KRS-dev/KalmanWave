...
if __name__ == "__main__":
    ...
    ax_peaks.plot(t_t, s_d[0,:], color = 'y', alpha=0.5)
    ax_peaks.plot(t_t, s_d[1,:], color = 'g', alpha=0.5)
    ax_peaks.plot(t_t, s_d[2,:], color = 'b', alpha=0.5)
    ax_peaks.plot(t_t, s_d[3,:], color = 'm', alpha=0.5)
    ax_peaks.plot(t_t, s_d[4,:], color = 'r', alpha=0.5)
    ...
    ax_peaks.scatter(positions[2], data_heights[2], color='b', marker = 'o', label = 'maxima Terneuzen')
    ax_peaks.scatter(positions[3], data_heights[3], color='m', marker = 'o', label = 'maxima Hansweert')
    ax_peaks.scatter(positions[4], data_heights[4], color='r', marker = 'o', label = 'maxima Bath')
    ax_peaks.set_title("Finding Peaks")
    ax_peaks.set_xlabel("time (s)")
    ax_peaks.set_ylabel("height (m)")
